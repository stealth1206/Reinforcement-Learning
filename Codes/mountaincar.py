...
class Agent:
	...
	def rem_tuple(self, state, action, reward, next_state, done):		# keeping memory of tuple of state,action,reward,next_state 
	...
	def replay(self):							# Fitting the model by finding Q-values
...
def main():
	...
	for episode in range(EPISODES):
		...
		for step in range(STEP):
			...
			agent.rem_tuple(state, action, reward, next_state, done)     # saving the tuple into memory
			score += reward
			state = next_state
			if done: 
